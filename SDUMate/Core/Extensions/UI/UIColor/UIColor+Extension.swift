...
//    }
    ...
    static var _164DDC: UIColor {
        return UIColor(hex: 0x164DDC)
    }
    
    static var _222294: UIColor {
        return UIColor(hex: 0x222294)
    }
    
    static var _FF453A: UIColor {
        return UIColor(hex: 0xFF453A)
    }
    
    static var _0A84FF: UIColor {
        return UIColor(hex: 0x0A84FF)
    }
    
    static var _FF5353: UIColor {
        return UIColor(hex: 0xFF5353)
    }
    
    static var _2A2848: UIColor {
        return UIColor(hex: 0x2A2848)
    }
    
    static var _F5F5F5: UIColor {
