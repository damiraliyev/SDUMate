...
internal enum Asset {
  ...
  internal static let icBiology = ImageAsset(name: "ic_biology")
  internal static let icBronzeBorder = ImageAsset(name: "ic_bronze_border")
  ...
  internal static let icChemistry = ImageAsset(name: "ic_chemistry")
  internal static let icClock = ImageAsset(name: "ic_clock")
  internal static let icClockLavender = ImageAsset(name: "ic_clock_lavender")
  internal static let icCloseX = ImageAsset(name: "ic_close_x")
  internal static let icCollaborate = ImageAsset(name: "ic_collaborate")
  internal static let icContactsBlur = ImageAsset(name: "ic_contacts_blur")
  internal static let icCreateOffer = ImageAsset(name: "ic_create_offer")
  internal static let icCreateRequest = ImageAsset(name: "ic_create_request")
  internal static let icCrown = ImageAsset(name: "ic_crown")
  internal static let icDataAnalysis = ImageAsset(name: "ic_data_analysis")
  internal static let icDelete = ImageAsset(name: "ic_delete")
  internal static let icDocument = ImageAsset(name: "ic_document")
  internal static let icDoubleAcceptance = ImageAsset(name: "ic_double_acceptance")
  ...
  internal static let icGoldBorder = ImageAsset(name: "ic_gold_border")
  ...
  internal static let icLanguage = ImageAsset(name: "ic_language")
  internal static let icLiterature = ImageAsset(name: "ic_literature")
  ...
  internal static let icOthers = ImageAsset(name: "ic_others")
  ...
  internal static let icSilverBorder = ImageAsset(name: "ic_silver_border")
  internal static let icSoftware = ImageAsset(name: "ic_software")
  internal static let icStar = ImageAsset(name: "ic_star")
  internal static let icStarEmptyGold = ImageAsset(name: "ic_star_empty_gold")
  internal static let icStarEmptyWhite = ImageAsset(name: "ic_star_empty_white")
  internal static let icSuitcase = ImageAsset(name: "ic_suitcase")
  internal static let icTrophyBronze = ImageAsset(name: "ic_trophy_bronze")
  internal static let icTrophyGold = ImageAsset(name: "ic_trophy_gold")
  internal static let icTrophySilver = ImageAsset(name: "ic_trophy_silver")
